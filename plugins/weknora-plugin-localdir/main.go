...
func readItem(root, relative string) (pluginapi.FetchedItem, error) {
	...
	return pluginapi.FetchedItem{ExternalID: "file:" + filepath.ToSlash(relative), Title: filepath.Base(relative), Content: data, MIMEType: "text/plain", UpdatedAt: info.ModTime().UTC().Format("2006-01-02T15:04:05.999999999Z07:00")}, nil
}
